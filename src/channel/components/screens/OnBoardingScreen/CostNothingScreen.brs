Function init()
  ...
  m.top.screenLevel = m.constants.ui.screenLevels.costNothingScreen
  m.top.trackingPageInfo = {
    pageType: "onboarding_page"
    pageValues: {
      page_sequence: m.constants.ui.pageSequence.costNothingScreen
    }
  }  
  ...
  m.pageHeading.text = getTranslation("onBoarding_costScreen_heading")
  m.pageDescription.text = getTranslation("onBoarding_costScreen_description")
...
Function onScreenFocusChange()
  tubiLog("CostNothing.onScreenFocusChange")
...
Function onButtonSelected()
  tubiLog("CostNothing.onButtonSelected")
