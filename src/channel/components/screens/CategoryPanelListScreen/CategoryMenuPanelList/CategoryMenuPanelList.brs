Function init()
  ...
  categoryMenuPanelList = constants.ui.categoryMenuPanelList
  m.Menu.columnWidths = categoryMenuPanelList.columnWidths
  m.Menu.itemSize = categoryMenuPanelList.itemSize
