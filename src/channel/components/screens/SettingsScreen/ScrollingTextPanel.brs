Function init()
  ...
  if m.global.constants.deviceInfo.scaledUi = true
    m.focusBitmapUri = "pkg:/images/transport/sgplayer/hd/focused-progress-foreground.9.png"
    m.focusFootprintUri = "pkg:/images/transport/sgplayer/hd/unfocused-progress-foreground.9.png"
  else
    m.focusBitmapUri = "pkg:/images/transport/sgplayer/fhd/focused-progress-foreground.9.png"
