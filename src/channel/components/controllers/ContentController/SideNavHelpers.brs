...
'//::TODO::SIDENAV - When screen is loading the user can open the side nav and set focus in side nav, which means when the screen finally loads, the first thumbnail does not gain focus so the infoPanel does not get completed 
