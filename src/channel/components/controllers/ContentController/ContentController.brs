...
Function refreshAllDetailScreens()
  ...
  isRokuRegTVTExpOn = FALSE AND (getExperimentResource("roku_registration_vs_tvt_lock_rated_content", "roku_registration_vs_tvt_lock_rated_content_v1", false).enabled = true)
