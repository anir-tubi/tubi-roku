...
Function shouldDisplayInitialContentScreen()
  bDisplay = false
  if m.constants.deviceInfo.countryCode = "US" and isParentalControlsAdultLevel() = true and m.uiMode <> m.constants.ui.modes.kidsAgeGate and getExperimentResource("roku_initial_content_type_selector_icts", "roku_initial_content_type_selector_icts_v2", true).icts_menu_option <> "no_icts"
