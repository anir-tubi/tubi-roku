...
Function onCreateMenuItems()
  ...
  if getExternalConfigValueFromGlobal("livetv", false) = true AND (sCountryCode <> "US" OR getExperimentResource("roku_linear_no_show", "roku_linear_no_show_v1", true).enabled = false)
