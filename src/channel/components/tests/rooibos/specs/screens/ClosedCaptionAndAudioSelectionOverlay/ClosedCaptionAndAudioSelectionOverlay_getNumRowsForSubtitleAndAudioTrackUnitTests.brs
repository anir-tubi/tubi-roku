...
Function number_getNumRowsForSubtitleAndAudioTrack_test()
  ...
  numRows = getNumRowsForSubtitleAndAudioTrack(5, 5)
  subtitle = numRows.subtitle
  audioTrack = numRows.audioTrack
  m.assertEqual(subtitle, 4)
  m.assertEqual(audioTrack, 4)

  numRows = getNumRowsForSubtitleAndAudioTrack(8, 3)
  subtitle = numRows.subtitle
  audioTrack = numRows.audioTrack
  m.assertEqual(subtitle, 5)
  ...
  numRows = getNumRowsForSubtitleAndAudioTrack(0, 5)
  subtitle = numRows.subtitle
  audioTrack = numRows.audioTrack
  m.assertEqual(subtitle, 0)
  m.assertEqual(audioTrack, 5)
End Function
