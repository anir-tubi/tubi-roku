...
Function getTranslation_en_US()
  return {
    ...
    "screenHome_showAllNotification": {
      ...
      "message": "To see all of {containerTitle}, press "
    },
    ...
    "privacy_preferences_dsar_section_heading": {
      ...
      "message": "Data Subject Rights"
    },
    "privacy_preferences_dsar_section_subheading": {
      "description": "DSAR section subheading.",
      "message": "To view your Data Rights and complete a request, scan the QR code below with your mobile device or visit "
    },
