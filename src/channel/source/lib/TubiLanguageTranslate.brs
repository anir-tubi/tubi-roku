...
Function getTranslation_en_US()
  return {
    ...
    "screenSettings_parentalControls_kids_instructions": {
      "description": "Description of the parental controls screen",
      "message": "Due to content restrictions, you must return to the adult account to update your content settings."
    },
    ...
    "screenMyStuff_allEmptyUISubtitle": {
      "description": "The subtitle of the MyStuff Screen for the guest user.",
      "message": "Use the bookmark button to save series and movies to My List, and quickly get back to what you were watching with Continue Watching."
    },
    ...
    "metadata_continueWatching_notSignedIn_description": {
      "description": "tells non registered user what they need to do to see the continue watching container",
      "message": "Pick up right where you left off next time you play a TV Series or a Movie."
    },
    ...
    "info_panel_only_on": {
      "description": "Prefix before the Only on Tubi logo on the content detail info first metadata line",
      "message": "Only on"
    },
    ...
    "send_feedback_submitted_description": {
      ...
      "message": "Your issue has been submitted. Based on your feedback we will improve the experience."
    },
    "send_feedback_overlay_feedback_hint": {
      ...
      "message": "To share more with us, scan the QR code with your mobile device or visit tubitv.com/static/support"
    },
    ...
    "send_feedback_menuItem_video_freeze": {
      "description": "Title of one of the menu item in the send feedback menu.",
      "message": "Video Freeze"
    },
    "send_feedback_menuItem_video_does_not_play": {
      "description": "Title of one of the menu item in the send feedback menu.",
      "message": "Video Doesn't Play"
    },
    ...
    "screenSettings_manage_account_description": {
      ...
      "message": "To update your info or manage preferences, scan the QR code or visit the URL. Relaunch the app to see any changes."
    },
    ...
    "kids_screen_heading": {
      ...
      "message": "Choose an Adult to Add a Kids Account"
    },
    "kids_screen_bottom_text_header": {
      "description": "Bottom text header of the kids screen",
      "message": "Want to sign into an existing Kids account?"
    },
    "kids_screen_bottom_text": {
      "description": "Bottom text of the kids screen",
      "message": "Switch to “For Adults” and sign in with an Adult Account — we’ll automatically sign in your kid."
    },
    ...
    "name_screen_heading_kids": {
      "description": "Heading of the name screen",
      "message": "What's your kid's first name?"
    },
    ...
    "kidsAgeSelection_header": {
      ...
      "message": "Choose a content setting"
    },
    ...
    "ParentalControlPinPad_sub_header": {
      ...
      "message": "This PIN prevents kids from changing Content Settings or leaving Tubi Kids."
    },
    ...
    "screenSettings_linked_accounts_description": {
      ...
      "message": "These are the Tubi Kids accounts that are linked to your Adult Account:"
    },
    "dialog_signOut_title_kids": {
      "description": "Title of the dialog window when the user is signing out of a kids account",
      "message": "Signing Out Logs Out Kids Accounts"
    },
    "dialog_signOut_description_kids": {
      ...
      "message": "You are about to sign out of Tubi account. This will log out all linked kids accounts."
    },
    ...
    "screenSettings_contentSettings_instructions": {
      ...
      "message": "Set content rating limits for you and your kids, and manage your PIN to keep viewing safe and age-appropriate."
    },
    ...
    "parental_pin_update_success_message": {
      ...
      "message": "Your new PIN is ready to use"
    },
    ...
    "too_many_kids_error_message": {
      ...
      "message": "You've reached the maximum number of kid profiles."
    },
    ...
    "guest_tile_title": {
      ...
      "message": "Sign Up to Save Your Stuff"
    },
    "guest_tile_description": {
      "description": "Description on guest user tile in My Stuff screen explaining benefits",
      "message": "Find your favorites fast, pick up where you left off — all in one place. Free forever."
    },
    ...
    "otpScreen_error_otp_mismatch": {
      "description": "Error message shown when the user enters an incorrect OTP code",
      "message": "Incorrect Code. Please try again."
    },
    "otpScreen_error_otp_expired": {
      "description": "Error message shown when the OTP code has expired",
      "message": "OTP expired. Please try again"
    },
    "otpScreen_error_too_many_attempts": {
      "description": "Error message shown when the user has made too many OTP attempts",
      "message": "Too many attempts. Please try later"
    },
    "otpScreen_error_unknown": {
      "description": "Error message shown when the OTP code is invalid",
      "message": "OTP error. Please try again"
    },
    "otpScreen_use_different_email_button_label": {
      "description": "Button label to allow the user to go back and use a different email",
      "message": "Use Different Email"
    },
    "otpScreen_resend_otp_button_label": {
      "description": "Button label to resend the OTP code to the user",
      "message": "Resend Code"
    },
    "otpScreen_header": {
      "description": "Header text on the OTP screen",
      "message": "Check your email"
    },
    "otpScreen_sub_heading": {
      "description": "Subheader text on OTP screen instructing user to enter the sign-in code",
      "message": "Enter the sign-in code we sent to"
    },
    "otpScreen_resend_otp_sent_label": {
      "description": "Label for the resend OTP button when the OTP has been sent",
      "message": "The sign-in code has been sent"
    },
    "otpScreen_resend_otp_message": {
      "description": "Message for the resend OTP button when the OTP has been sent",
      "message": "The sign-in code has been sent to "
    },
    "explore": {
...
Function getTranslation_es_MX()
  return {
    ...
    "metadata_audio_description": {
      "description": "metadata label to indicate audio description is available",
      "message": "Descripción de audio disponible"
    },
    "metadata_seasons_plural": {
      "description": "Label of how many seasons of the current TV title",
    ...
    "screenDetails_season_label": {
      "description": "Label for season button in episode list",
      "message": "Temporada {seasonNumber}"
    },
    "sponsor_brought_by": {
      "description": "When content is sponsored by an advertizer, then this text proceeds the image of the sponsor. The text and the image should make a complete sentence.",
    ...
    "rating_tv_y_description": {
      "description": "Description for TV-Y rating (All Children)",
      "message": "Diseñado para ser apto para todos los niños."
    },
    "rating_tv_y7_description": {
      "description": "Description for TV-Y7 rating (Directed to Older Children)",
      "message": "Diseñado para niños de 7 años en adelante."
    },
    "rating_tv_y7_fv_description": {
      "description": "Description for TV-Y7-FV rating (Directed to Older Children - Fantasy Violence)",
      "message": "Diseñado para niños de 7 años en adelante y puede contener violencia fantástica."
    },
    "rating_tv_g_description": {
      "description": "Description for TV-G rating (General Audience)",
      "message": "La mayoría de los padres lo considerará apto para todas las edades."
    },
    "rating_tv_pg_description": {
      "description": "Description for TV-PG rating (Parental Guidance Suggested)",
      "message": "Contiene material que los padres pueden considerar inapropiado para niños pequeños."
    },
    "rating_tv_14_description": {
      "description": "Description for TV-14 rating (Parents Strongly Cautioned)",
      "message": "Contiene material inapropiado para menores de 14 años."
    },
    "rating_tv_ma_description": {
      "description": "Description for TV-MA rating (Mature Audience Only)",
      "message": "Diseñado para adultos; puede ser inapropiado para menores de 17 años."
    },
    "rating_g_description": {
      "description": "Description for G rating (General Audiences)",
      "message": "Apto para todo público. Nada que ofenda a los padres o niños."
    },
    "rating_pg_description": {
      "description": "Description for PG rating (Parental Guidance Suggested)",
    ...
    "rating_pg_13_description": {
      "description": "Description for PG-13 rating (Parents Strongly Cautioned)",
      "message": "Parte del contenido puede ser inapropiado para menores de 13 años. Se recomienda precaución a los padres."
    },
    "rating_r_description": {
      "description": "Description for R rating (Restricted)",
      "message": "Menores de 17 deben ir acompañados. Contiene material para adultos. Se recomienda a los padres informarse antes de asistir con niños."
    },
    "rating_nc_17_description": {
      "description": "Description for NC-17 rating (Adults Only)",
      "message": "No se admite a menores de 17 años. Solo para adultos."
    },
    "button_episodes": {
      "description": "Label of button to allow users to display the list of episodes/seasons of the current video title. Should be title case.",
      "message": "Capítulos"
...
Function getTranslation_fr_CA()
  return {
    ...
    "metadata_audio_description": {
      "description": "metadata label to indicate audio description is available",
      "message": "Description audio disponible"
    },
    "metadata_seasons_plural": {
      "description": "Label of how many seasons of the current TV title",
    ...
    "linearVideoPlayer_adCounter": {
      "description": "Label to display ad counter in linear video player",
      "message": "Pub {ad_index} sur {ad_count}"
    },
    "channel_name": {
      "description": "This is the name of the app. This is not located in the app. It is displayed to the user in the Roku Channel Store",
    ...
    "rating_tv_y_description": {
      "description": "Description for TV-Y rating (All Children)",
      "message": "Conçu pour convenir à tous les enfants."
    },
    "rating_tv_y7_description": {
      "description": "Description for TV-Y7 rating (Directed to Older Children)",
      "message": "Conçu pour les enfants de 7 ans et plus."
    },
    "rating_tv_y7_fv_description": {
      "description": "Description for TV-Y7-FV rating (Directed to Older Children - Fantasy Violence)",
      "message": "Conçu pour les enfants de 7 ans et plus et peut contenir de la violence fantastique."
    },
    "rating_tv_g_description": {
      "description": "Description for TV-G rating (General Audience)",
      "message": "La plupart des parents jugeront ce programme convenable pour tous âges."
    },
    "rating_tv_pg_description": {
      "description": "Description for TV-PG rating (Parental Guidance Suggested)",
      "message": "Contient du matériel que les parents peuvent juger inapproprié pour les jeunes enfants."
    },
    "rating_tv_14_description": {
      "description": "Description for TV-14 rating (Parents Strongly Cautioned)",
      "message": "Contient du matériel jugé inapproprié pour les moins de 14 ans."
    },
    "rating_tv_ma_description": {
      "description": "Description for TV-MA rating (Mature Audience Only)",
      "message": "Conçu pour un public adulte; peut être inapproprié pour les moins de 17 ans."
    },
    "rating_g_description": {
      "description": "Description for G rating (General Audiences)",
      "message": "Tous publics. Rien qui puisse offenser parents ou enfants."
    },
    "rating_pg_description": {
      "description": "Description for PG rating (Parental Guidance Suggested)",
    ...
    "rating_pg_13_description": {
      "description": "Description for PG-13 rating (Parents Strongly Cautioned)",
      "message": "Certains contenus peuvent être inappropriés pour les moins de 13 ans. Les parents devraient faire preuve de prudence."
    },
    "rating_r_description": {
      "description": "Description for R rating (Restricted)",
      "message": "Les moins de 17 ans doivent être accompagnés d’un adulte. Contient du matériel pour adultes. Les parents sont invités à se renseigner avant d’y emmener leurs enfants."
    },
    "rating_nc_17_description": {
      "description": "Description for NC-17 rating (Adults Only)",
      "message": "Interdit aux moins de 17 ans. Réservé aux adultes."
    },
    "button_episodes": {
      "description": "Label of button to allow users to display the list of episodes/seasons of the current video title. Should be title case.",
      "message": "Épisodes"
...
Function getTranslation_en_GB()
  return {
    ...
    "rating_tv_y_description": {
      "description": "Description for TV-Y rating (All Children)",
      "message": "This programme is designed to be appropriate for all children."
    },
    "rating_tv_y7_description": {
      "description": "Description for TV-Y7 rating (Directed to Older Children)",
      "message": "This programme is designed for children age 7 and above."
    },
    "rating_tv_y7_fv_description": {
      "description": "Description for TV-Y7-FV rating (Directed to Older Children - Fantasy Violence)",
      "message": "This programme is designed for children age 7 and above and may contain fantasy violence."
    },
    "rating_tv_g_description": {
      "description": "Description for TV-G rating (General Audience)",
      "message": "Most parents will find this programme suitable for all ages."
    },
    "rating_tv_pg_description": {
      "description": "Description for TV-PG rating (Parental Guidance Suggested)",
      "message": "This programme contains material that parents may find unsuitable for younger children."
    },
    "rating_tv_14_description": {
      "description": "Description for TV-14 rating (Parents Strongly Cautioned)",
      "message": "This programme contains material that many parents would find unsuitable for children under 14 years of age."
    },
    "rating_tv_ma_description": {
      "description": "Description for TV-MA rating (Mature Audience Only)",
