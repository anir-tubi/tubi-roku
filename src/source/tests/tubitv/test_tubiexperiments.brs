Function testInitSuccess(t As Object)
  constants = getConstants()
  request = TubiRequest()
  experiments = TubiExperiments(request, constants)
  experiments.getNamespaces = MockGetNamespaces

  t.assertInvalid(constants.experiments.info)
  experiments.init()
  t.assertNotInvalid(constants.experiments.info)
End Function

Function testInitFailed(t As Object)
  constants = getConstants()
  request = TubiRequest()
  experiments = TubiExperiments(request, constants)
  experiments.getNamespaces = MockGetInvalidNamespaces
  t.assertInvalid(constants.experiments.info)
  experiments.init()
  t.assertInvalid(constants.experiments.info)
  ...
  t.assertNotInvalid(value)
  t.assertTrue(value.DoesExist("experimentvalue"))
  t.assertTrue(value.DoesExist("trackinfo"))
  t.assertInvalid(value.experimentvalue)

End Function

Function testGetValidExperimentValue(t As Object)
  constants = getConstants()
  request = TubiRequest()
  experiments = TubiExperiments(request, constants)
  experiments.getNamespaces = MockGetNamespaces
  ...
  t.assertTrue(value.DoesExist("experimentvalue"))
  t.assertTrue(value.DoesExist("trackinfo"))
  t.assertFalse(value.experimentvalue)
End Function

Function testGetDefaultExperimentValue(t As Object)
  constants = getConstants()
  request = TubiRequest()
  experiments = TubiExperiments(request, constants)
  experiments.getNamespaces = MockGetNamespaces
  ...
  t.assertTrue(value.DoesExist("experimentvalue"))
  t.assertTrue(value.DoesExist("trackinfo"))
  t.assertTrue(value.experimentvalue)
End Function

Function testGetInvalidExperimentValue(t As Object)
  constants = getConstants()
  request = TubiRequest()
  experiments = TubiExperiments(request, constants)
  experiments.getNamespaces = MockGetNamespaces
...
Function MockGetInvalidNamespaces() As Object
  return invalid
End Function
...
Function MockGetNamespaces() As Object
