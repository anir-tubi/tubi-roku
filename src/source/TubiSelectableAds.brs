function TubiSelectableAds(utils)
  return {
    getUserChoice: tubiSelectableAds_getUserChoice
	  showUserSelectedVideoAd: tubiSelectableAds_showUserSelectedVideoAd
	  handleAdClick: tubiSelectableAds_handleAdClick
	  utils: utils
  }
end function

' ******************************************************
'  tubiSelectableAds_showUserSelectedVideoAd(adUnit)
'   returns "CLOSED" or "COMPLETED"
' ******************************************************
function tubiSelectableAds_showUserSelectedVideoAd(adUnit As Object)
...
' ******************************************************
'  tubiSelectableAds_handleAdClick(adUnit)
'   either show the selected video, or, if the adUnit says so,
'   go to the app in the store
' ******************************************************
function tubiSelectableAds_handleAdClick(adUnit)
...
' ******************************************************
function tubiSelectableAds_getUserChoice(adOptions, duration, definition)
