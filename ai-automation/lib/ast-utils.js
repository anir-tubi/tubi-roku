 ...
 * @returns {{describeBlocks: Array<{name: string, startLine: number, endLine: number, level: number}>, unclosedDescribes: Array<{name: string, startLine: number, level: number, braceDepthAtStart: number}>}}
 */
