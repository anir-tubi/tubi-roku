...
const elements = typeCheckElements({
  ...
  screenStack: {
    keyPath: '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack',
  },

  topNavForYouLabelNotFocused: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#homeScreen.#PageGroup.#topNav-home.#TopNavMenu.0.#unfocusedTopLabel',
  },

  topNavForYouLabelFocused: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#homeScreen.#PageGroup.#topNav-home.#TopNavMenu.0.#focusedBottomLabel',
  },

  previewOff: {
    keyPath: '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#settingsScreen.#PageGroup.#PanelSet.3.#Offset.#ContentGroup.#AutoplayPreviewMenu.1.#container',
  },
  ...
  autoplayInstructions: {
    keyPath: '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#settingsScreen.#PageGroup.#PanelSet.3.#Offset.#ContentGroup.#Instructions',
  },

  episodesList: {
    keyPath: '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#episodeScreen.#PageGroup.#RowList.0.title.#CategoryName',
  },
  ...
  homeScreenRowList: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#homeScreen.#PageGroup.#ContentArea.#CategoryGridList.#RowList',
  },

  /** Component on the redesigned Home Screen (RowList) */
  videoTitlesRowList: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#homeScreen.#PageGroup.#ContentAreaParent.#ContentArea.#CategoryGridList.#RowList',
  },
  ...
  pivotList: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#homeScreen.#PageGroup.#pivotList',
  },

  /** PivotList component on the Movie Screen */
  movieScreenPivotList: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#movieScreen.#PageGroup.#pivotList',
  },

  /** PivotList component on the TV Screen */
  tvScreenPivotList: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#tvScreen.#PageGroup.#pivotList',
  },

  /** PivotList component on the Espanol Screen */
  espanolScreenPivotList: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#espanolScreen.#PageGroup.#pivotList',
  },

  /** RowList component on Pivot Detail Screen (after clicking a pivot) */
  pivotDetailRowList: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#pivotDetailScreen.#PageGroup.#rowList',
  },
  ...
  /** movieScreenRowList (auto-updated) */
  movieScreenRowList: {
    keyPath: '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#movieScreen.#RowList',
  },

  /** Movie screen first row category name */
  movieScreenFirstRowName: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#movieScreen.#ContentArea.#CategoryGridList.#RowList.0.title.#CategoryName',
  },

  /** Espanol Row List */
  espanolHomeScreenRowList: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#espanolScreen.#PageGroup.#ContentArea.#CategoryGridList.0',
  },

  /** Category name */
  categoryGridRowList: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#espanolScreen.#PageGroup.#ContentArea.#CategoryGridList.#RowList',
  },

  /** Categories details page */
  categoriesDetailsPageInfo: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#categoryPanelListScreen.#PageGroup.#PanelSet.3.#PageGroup.#PageAnimatedGroup.#ChannelsInfoPanel.#infoPanelGroup.#Offset',
  },

  categoryGridTitle: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#categoryListScreen.#PageGroup.#ChannelCategoryGrid.1.#Title',
  },

  /** Network page infopanel */
  networkPageInfoPanelDescription: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#categoryPanelListScreen.#PageGroup.#PanelSet.3.#PageGroup.#PageAnimatedGroup.#ChannelsInfoPanel.#infoPanelGroup.#Offset.#DescriptionGroup.#Description',
  },

  /** TV Shows screen row list */
  tvShowsScreenRowList: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#tvScreen.#ContentArea.#CategoryGridList.#RowList',
  },

  /** TV Shows screen first row category name */
  tvShowsScreenFirstRowName: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#tvScreen.#ContentArea.#CategoryGridList.#RowList.0.title.#CategoryName',
  },

  /** Sea Lion Sign In to Watch text */
  slSignInToWatch: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#homeScreen.#PageGroup.#ContentArea.#CategoryGridList.#purpleCarpetRow.0.#infoPanelGroup.#ctaButtonList.0.#menuItemTextFocused',
  },

  slWatchLiveButton: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#homeScreen.#PageGroup.#ContentArea.#CategoryGridList.#purpleCarpetRow.0.#infoPanelGroup.#ctaButtonList.0.#menuItemBg',
  ...
  liveScreenHeader: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#epgScreen.#PageGroup.#programGuide.#headerText',
  },
  ...
  likeButton: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#detailScreen.#PageGroup.#AnimationGroup.#SecondaryMenu.0.#buttonBG',
  },
  ...
  categoryMyListMenuItemFocused: {
    keyPath: '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#categoryPanelListScreen.#PageGroup.#PanelSet.2.#MenuGroup.#Menu.1.#DetailsMenuTextParent.#DetailsMenuTextFocused',
  },

  categoryMyListMenuItem: {
    keyPath: '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#categoryPanelListScreen.#PageGroup.#PanelSet.2.#MenuGroup.#Menu.1.#DetailsMenuTextParent.#DetailsMenuText',
  },

  allEpisodesButton: {
    keyPath: '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#detailScreen.#PageGroup.#AnimationGroup.#Menu.1.#DetailsMenuTextParent.#DetailsMenuText',
  },

  allEpisodesButtonFocused: {
    keyPath: '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#detailScreen.#PageGroup.#AnimationGroup.#Menu.1.#DetailsMenuTextParent.#DetailsMenuTextFocused',
  },
  ...
  titleDetailsRatingsLabel: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#detailScreen.#AnimationGroup.#DetailInfoPanel.#infoPanelGroup.#Offset.#TwoLineInfo.#FirstLineGroup.#Rating.#RatingLabel',
  },

  closedCaptionPosterInDetailsPage: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#detailScreen.#AnimationGroup.#DetailInfoPanel.#infoPanelGroup.#Offset.#TwoLineInfo.#FirstLineGroup.#ClosedCaptionPoster',
  },

  /** Settings Screen */
  settingsScreen: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#settingsScreen',
  },

  /** Search Screen */
  searchScreen: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#searchScreen',
  },

  /** Settings page */
  settingsPagePanelSet: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#settingsScreen.#PageGroup.#PanelSet',
  },

  /** Enter Password Message */
  enterPasswordMessage: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.2.0.#Message',
  },

  /** Password Entry Box */
  passwordEntryBox: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.2.0.#password',
  },
  ...
  signOutButtonKidsMode: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#settingsScreen.#PanelSet.2.#SettingsMenuGroup.#SettingsMenu.4.#DetailsMenuTextParent.#DetailsMenuText',
  },
  ...
  detailScreen: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#detailScreen',
  },
  ...
  detailScreenTitle: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#detailScreen.#PageGroup.#AnimationGroup.#DetailInfoPanel.#infoPanelGroup.#Offset.#Title',
  },

  /** Content title on the detail screen */
  detailScreenPanel: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#detailScreen.#AnimationGroup.#DetailInfoPanel.#infoPanelGroup',
  },

  /** Component containing year and duration of the current content */
  detailScreenYearAndDuration: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#detailScreen.#AnimationGroup.#DetailInfoPanel.#infoPanelGroup.#Offset.#TwoLineInfo.#FirstLineGroup.#Line1',
  },

  detailScreenMenu: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#detailScreen.#PageGroup.#AnimationGroup.#Menu',
  },

  /** Add to My List Button */
  addToMyListButton: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#detailScreen.#AnimationGroup.#Menu.4.#DetailsMenuText',
  },

  /** Add to My List Button */
  addToMyListButtonFocused: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#detailScreen.#PageGroup.#AnimationGroup.#Menu.3.#DetailsMenuTextParent.#DetailsMenuTextFocused',
  },

  /** Remove From My List Button */
  removeFromMyListButton: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#detailScreen.#AnimationGroup.#Menu.3.#DetailsMenuText',
  },
  ...
  playListButton: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#detailScreen.#AnimationGroup.#Menu.1.#buttonBG',
  },

  /** Play Button icon focused */
  playButtonIconFocused: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#detailScreen.#PageGroup.#AnimationGroup.#Menu.0.#IconParent.#IconFocused',
  },

  /** On Movies Page Button */
  onMoviesPageButton: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#movieScreen.#PageGroup.#topNav-movies.#TopNavMenu.1.#selectedBackground',
  },

  myStuffContinueWatchingRow: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#myStuffScreen.#PageGroup.#ContentArea.#RowList.1.title.#CategoryName',
  },

  emailTexEditBox: {
    keyPath: '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#emailInputScreen.#emailLayout.1.#emailTextEditBox.0',
  },

  /** Resend button on Magic Link */
  resendButtonMagicLink: {
    keyPath: '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#emailVerificationScreen.#pageLayout.#buttonGroup.#resendBtn.#focus9Patch',
  },

  /** Progress bar on resumed button */
  resumedProgressBar: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#detailScreen.#AnimationGroup.#Menu.0.#ResumeProgressBar',
  },
  ...
  relatedYMALGrid: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#detailScreen.#AnimationGroup.#RelatedContentParentGroup.#RelatedContentGroup.#RelatedGrid',
  },

  /** Detail Page Info Panel */
  detailInfoPanel: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#detailScreen.#AnimationGroup.#DetailInfoPanel.#infoPanelGroup.#Offset',
  },

  /** Play Button is selected */
  playButtonSelected: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#detailScreen.#AnimationGroup.#Menu.0',
  },

  tubiEspanolPage: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#homeScreen.#ContentArea.#CategoryGridList.#RowList.0.title.#CategoryName',
    xpath:
  ...
  homePageSponsoredByText: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#homeScreen.#ContentArea.#CategoryGridList.#RowList.0.title.#SponsoredBy.#SponsoredByText',
    xpath:
  ...
  homeScreenRatingsLabel: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#homeScreen.#InfoPanelParent.#InfoPanel.#infoPanelGroup.#Offset.#TwoLineInfo.#FirstLineGroup.#Rating.#RatingLabel',
    xpath:
  ...
  channelDescription: {
    keyPath: '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#categoryDetailsScreen.#PageGroup.#ChannelsInfoPanel.#infoPanelGroup.#Offset.#DescriptionGroup.#Description',
  },

  titleDetailsDescriptionContainer: {
    keyPath: '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#categoryPanelListScreen.#PageGroup.#PanelSet.3.#PageGroup.#PageAnimatedGroup.#ChannelsInfoPanel.#infoPanelGroup.#Offset.#Title',
  },

  homeRowList: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#homeScreen.#ContentArea.#CategoryGridList.#RowList',
    xpath:
  ...
  homeScreenFeaturedPoster: {
    keyPath: '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#homeScreen.#PageGroup.#ContentArea.#CategoryGridList.#RowList.0.items.0.#poster',
  },

  youMightAlsoLikeFirstPoster: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#detailScreen.#AnimationGroup.#RelatedContentParentGroup.#RelatedContentGroup.#RelatedGrid.0.#poster',
  },

  topNavRecommendedRedLabel: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#homeScreen.#topNav-home.#TopNavMenu.0.#BottomLabel',
    xpath:
  ...
  topNavRecommendedWhiteLabel: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#homeScreen.#topNav-home.#TopNavMenu.0',
    xpath:
  ...
  topNavForYouLabel: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#homeScreen.#topNav-home.#TopNavMenu.0.#TopLabel',
    xpath:
  ...
  NBCDescription: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#homeScreen.#InfoPanelParent.#InfoPanel.#infoPanelGroup.#Offset.#Title',
    xpath:
  ...
  myStuffRegScreenTitle: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#myStuffScreen.#PageGroup.#AllEmptyUI.#AllEmptyUITitle',
  },

  myStuffRegScreenSubTitle: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#myStuffScreen.#PageGroup.#AllEmptyUI.#AllEmptyUISubtitle',
  },

  myStuffRegScreenSubTitle2: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#myStuffScreen.#PageGroup.#AllEmptyUI.#AllEmptyUISubtitle2',
  },
  ...
  homeInfoPanel: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#homeScreen.#InfoPanelParent.#InfoPanel.#infoPanelGroup.#Offset',
    xpath:
  ...
  topNavNewsLabel: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#homeScreen.#topNav-home.#TopNavMenu.3.#BottomLabel',
    xpath:
  ...
  topNavMenuHome: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#homeScreen.#topNav-home',
  },

  titleMovieDetailsTitle: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#detailScreen.#AnimationGroup.#DetailInfoPanel.#infoPanelGroup.#Offset.#Title',
    xpath:
  ...
  detailsPageMenu: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#detailScreen.#AnimationGroup.#Menu',
  },

  secondaryMenuactive: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#detailScreen.#AnimationGroup.#SecondaryMenu',
    xpath:
  ...
  addToMyListSelected2: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#detailScreen.#AnimationGroup.#Menu.3',
    xpath:
  ...
  titleSeriesBackgroundPoster: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#detailScreen.#AnimationGroup.#RelatedContentParentGroup',
    xpath:
  ...
  secondaryMenuButtonDislike: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#detailScreen.#PageGroup.#AnimationGroup.#SecondaryMenu.1.#buttonBG',
  },
  ...
  titleStarringLabel: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#detailScreen.#AnimationGroup.#DetailInfoPanel.#infoPanelGroup.#Offset.#DirectorGroup.#DirectorPrefix.#DirectorTag',
    xpath:
  ...
  titleDescriptionNew: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#detailScreen.#AnimationGroup.#DetailInfoPanel.#infoPanelGroup.#Offset.#DescriptionGroup.#Description',
    xpath:
  ...
  /** YMAL detail title */
  ymalDetailsTitle: {
    keyPath: '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#videoPlayerScreen.#YmalRow.0.#YmalGroup.#Info.#infoPanelGroup.#Offset.#Title',
  },


  /** YMAL player poster */
  videoPlayYmalPoster: {
    keyPath: '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#videoPlayerScreen.#YmalRow.0.#YmalGroup.#YmalRow.#CategoryGridList.#RowList.0.items.0.#poster',
  },
  ...
  transportButtons: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#videoPlayerScreen.#HUD.#Transport.#TransportButtons',
  },
  ...
  autoplayFirstTitleFocus: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#videoPlayerScreen.#UpNext.#UpNextUI.#UpNextMovieGroup.#FocusBox',
    xpath:
  ...
  autoplayUpNextScreen: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#videoPlayerScreen.#UpNext.#UpNextUI.#UpNextMovieGroup',
    xpath:
  ...
  autoplaySecondTitleFocus: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#videoPlayerScreen.#UpNext.#UpNextUI.#UpNextMovieGroup.#GridMovie',
    xpath:
  ...
  autoplayCountdownTimerSection: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#videoPlayerScreen.#UpNext.#UpNextUI.#CountdownTimerParent'
  },

  videoPlayerActual: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#videoPlayerScreen.#VideoNode',
    xpath:
  ...
  videoPlayerScreenTopOverlay: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#videoPlayerScreen.#TopOverlay',
  },

  autoplayNextEpisodeLabel: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#videoPlayerScreen.#UpNext.#UpNextUI.#UpNextSeriesGroup.#InfoSeries.#infoPanelGroup.#Offset.#Title',
    xpath:
  ...
  olderKidsCheckButton: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#settingsScreen.#PanelSet.3.#Offset.#ContentGroup.#ParentalControlsMenu.1.#BtnLayout.#Check',
    xpath:
  ...
  searchResultChannelNameABC: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#searchScreen.#SearchScreenInfoPanel.#infoPanelGroup.#Offset.#Title',
    xpath:
      '/TubiScene/ContentController/Group/Group/ScreenStack/SearchScreen/InfoPanel/LayoutGroup/LayoutGroup/Label',
  },

  directorTag: {
    keyPath: '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#detailScreen.#PageGroup.#AnimationGroup.#DetailInfoPanel.#infoPanelGroup.#Offset.#DirectorGroup.#DirectorPrefix.#DirectorTag',
  },

  starringTag: {
    keyPath: '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#detailScreen.#PageGroup.#AnimationGroup.#DetailInfoPanel.#infoPanelGroup.#Offset.#StarringGroup.#StarringPrefix.#StarringTag',
  },
  ...
  noMatchingResultsMessage: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#searchScreen.#PageGroup.#rightSide.#rightSideTextGroup.#searchResultsMessageContainer.#noMatchingResultsMessage',
  },

  kidsSearchResultsText: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#searchScreen.#PageGroup.#leftSide.0.#searchMenuText',
  },

  searchResultFoxWeather: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#searchScreen.#SearchScreenInfoPanel.#infoPanelGroup.#Offset.#Episode',
    xpath:
      '/TubiScene/ContentController/Group/Group/ScreenStack/SearchScreen/InfoPanel/LayoutGroup/LayoutGroup/Label',
  },
  ...
  searchResultsLiveIcon: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#searchScreen.#SearchScreenInfoPanel.#infoPanelGroup.#Offset.#TwoLineInfo.#SecondLineGroup.#SecondLineAvailabilityBadge.#BadgeInfoLayout.#BadgeIcon',
    xpath:
      '/TubiScene/ContentController/Group/Group/ScreenStack/SearchScreen/InfoPanel/LayoutGroup/LayoutGroup/Label',
  },
  ...
  kidsSearchResultsGrid: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#searchScreen.#PageGroup.#ResultArea.#gridContainer.#trendingSearchResultsContainer.#trendingSearchResultGrid',
  },

  trendingSearchResultsGrid: {
    keyPath: '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#searchScreen.#PageGroup.#rightSide.#ResultArea.#gridContainer.#trendingSearchResultsContainer.#trendingSearchResultGrid',
  },

  trendingSearchResultsContainer: {
    keyPath: '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#searchScreen.#PageGroup.#rightSide.#ResultArea.#gridContainer.#trendingSearchResultsContainer',
  },
  ...
  trendingSearchesHeader: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#searchScreen.#PageGroup.#ResultArea.#gridContainer.#resultsContainer.#SearchText',
  },

  trendingSearchResult11: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#searchScreen.#PageGroup.#ResultArea.#gridContainer.#trendingSearchResultsContainer.#trendingSearchResultGrid.10.#poster',
  },

  btnCC_label: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#linearVideoPlayerScreen.#VideoOverlay.#overlayParent.#overlayContentArea.#sideNav.#sideNav.#btnCC.#btnCC_label',
    xpath:
  ...
  linearEPGFoxSportsDescription: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#epgScreen.#infoPanelParent.#infoPanel.#infoPanelGroup.#Offset.#DescriptionGroup.#Description',
    xpath:
  ...
  epgFullTVGuide: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#linearVideoPlayerScreen.#VideoOverlay.#overlayParent.#overlayContentArea.#sideNav.#sideNav.#btnBack.#btnBack_label',
    xpath:
  ...
  liveNewsFullscreenPlayer: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#linearVideoPlayerScreen',
    xpath:
  ...
  videoPlayerScreen: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#videoPlayerScreen',
  },
  ...
  linearOverlayContentArea: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#linearVideoPlayerScreen.#VideoOverlay.#overlayParent.#overlayContentArea',
  },

  /** Program grid in linear video player */
  linearProgramGrid: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#linearVideoPlayerScreen.#VideoOverlay.#EPG.#ProgramGrid',
  },

  /** Fox Player element ID */
  foxPLayerElementID: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#FoxVideoPlayerWrapperScreen.1.0',
  },
  ...
  liveTVTitle: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#epgScreen.#infoPanelParent.#infoPanel.#infoPanelGroup.#Offset.#Title',
    xpath:
  ...
  myListScreenTitle: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#myStuffScreen.#InfoPanel.#infoPanelGroup.#Offset.#Title',
  },
  ...
  continueWatchingRow: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#myStuffScreen.#PageGroup.#ContentArea.#RowList.0.title.#CategoryName',
  },

  resumeButton: {
    keyPath: '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#detailScreen.#PageGroup.#AnimationGroup.#Menu.0'
  },
  ...
  continueWatchingCategoryPoster: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#categoryPanelListScreen.#PageGroup.#PanelSet.3.#PageGroup.#PageAnimatedGroup.#ChannelsContentGrid.0.#posterLayout.#Poster',
  },
  ...
  myListPoster: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#myStuffScreen.#PageGroup.#ContentArea.#RowList.1.items.0.0',
  },
  ...
  categoriesDetailsGrid: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#categoryDetailsScreen.#ChannelsVideoGrid',
  },

  /** Categories video grid */
  categoriesDetailsVideoGridPoster: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#categoryDetailsScreen.#PageGroup.#ChannelsVideoGrid.0.#poster',
  },

  /** Categories 6th poster */
  categoriesVideoGridPoster6: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#categoryDetailsScreen.#PageGroup.#ChannelsVideoGrid.5.#poster',
  },

  /** Item counter */
  itemCounter: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#categoryPanelListScreen.#PageGroup.#PanelSet.3.#PageGroup.#PageAnimatedGroup.#pageTitleAndCounter.#CategoryCount.#ItemCount',
  },
  ...
  channelsListScreenPoster: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#channelListScreen.#PageGroup.#ChannelCategoryGrid.0.#PosterRect',
  },
  ...
  categoriesScreenContentGrid: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#categoryPanelListScreen.#PageGroup.#PanelSet.3.#PageGroup.#PageAnimatedGroup.#ChannelsContentGrid',
  },

  categoryContent: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#categoryListScreen.#PageGroup.0.content',
  },
  ...
  episodesScreen: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#episodeScreen.#PageGroup.#RowList.0.items.0.#FeaturePoster.#Background',
  },

  /** Marker to determine if we are on the Episodes page */
  episodesScreenSeasonHeader: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#episodeScreen.#PageGroup.#RowList.0.title.#CategoryName',
  },

  /** Episodes list */
  episodesListButton: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#detailScreen.#PageGroup.#AnimationGroup.#Menu.2.#DetailsMenuTextParent.#DetailsMenuText',
  },

  episodesScreenRowList: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#episodeScreen.#PageGroup.#RowList',
  },
  ...
  signInScreenPasswordBox: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#signInScreen.#signUpLayout.#password.#rectBG',
  },
  ...
  continueButtonSignInPage: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#signInScreen.#signUpLayout.#buttonsGroup.#continueBtn.#focus9Patch',
  },
  ...
  passwordKeyboard: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#signInScreen.#passwordEntryKeyboard.0.#Keyboard.0',
  },
  ...
  parentalControlsSettingsGroup: {
    keyPath: '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#settingsScreen.#PageGroup.#PanelSet.3.#Offset.#ContentGroup',
  },
  ...
  passwordText: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.2.0.#password.#Text',
  },

  keyboardBackButton: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.2.0.#buttonGroup.#back.#focus9Patch',
  },
  ...
  adultControlSelected: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#settingsScreen.#PageGroup.#PanelSet.3.#Offset.#ContentGroup.#ParentalControlsMenu.3.#container',
  },

  /** Live Icon */
  liveExpireTime: {
    keyPath: '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#homeScreen.#PageGroup.#InfoPanelParent.#InfoPanel.#infoPanelGroup.#Offset.#TwoLineInfo.#FirstLineGroup.#ExpireWarning',
  },
  ...
  autoplayPreviewOff: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#settingsScreen.#PanelSet.3.#Offset.#ContentGroup.#AutoplayPreviewMenu.1.#BtnLayout',
  },
  ...
  tvShowsSeriesLabel: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#tvScreen.#InfoPanelParent.#InfoPanel.#infoPanelGroup.#Offset.#TwoLineInfo.#FirstLineGroup.#Line1',
  },
  ...
  emailAddressBox: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#emailInputScreen.#emailLayout.1.#emailTextEditBox',
  },

  /** Enter Email Address Page Title */
  enterEmailAddressTitle: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#emailInputScreen.#emailLayout.#pageHeading',
  },
  ...
  confirmYourAgeText: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.1.#AgeVerificationPageText.#AgeVerificationPageHeader',
  },

  ageGateHeaderInRegistrationFlow: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.2.#AgeVerificationPageText.#AgeVerificationPageHeader'
  },

  /** age gate year box */
  ageGateYearsBox: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.3.2.#AgeVerificationAgeBg.#AgeVerificationAgeEntry',
  },

  /** age gate invalid age */
  ageGateInvalidAge: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.2.#AgeErrorPrompt',
  },
  ...
  ageGateVerificationErrorPrompt: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.1.#AgeVerificationErrorPrompt',
  },
  ...
  detailExpiresWarningLabel: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#detailScreen.#AnimationGroup.#DetailInfoPanel.#infoPanelGroup.#Offset.#TwoLineInfo.#FirstLineGroup.#ExpireWarning',
  },

  /** movies label */
  moviesLabel: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#movieScreen.#InfoPanelParent.#InfoPanel.#infoPanelGroup.#Offset.#TwoLineInfo.#FirstLineGroup.#Line1',
  },

  /** movies Expires Warning Label */
  moviesExpiresWarningLabel: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#movieScreen.#InfoPanelParent.#InfoPanel.#infoPanelGroup.#Offset.#TwoLineInfo.#FirstLineGroup.#ExpireWarning',
  },

  /** resume playing button */
  resumePlayingButton: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#detailScreen.#AnimationGroup.#Menu.0.#DetailsMenuTextParent.#DetailsMenuTextFocused',
  },

  /** Play button */
  playFromBeginning: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#detailScreen.#PageGroup.#AnimationGroup.#Menu.1.#DetailsMenuTextParent.#DetailsMenuText',
  },

  /** Sign up to save Progress description */
  signUpToSaveProgressDescription: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#homeScreen.#InfoPanelParent.#InfoPanel.#infoPanelGroup.#Offset.#DescriptionGroup.#Description',
  },

  /** poster present */
  movieScreenPoster: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#movieScreen.#ContentArea.#CategoryGridList.#RowList.5.items.0.#poster',
  },
  ...
  termsScreenHeader: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#settingsScreen.#PanelSet.3.#Offset.#ContentGroup.#Title',
  },

  /** About menu item */
  aboutMenuItem: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#settingsScreen.#PanelSet.2.#SettingsMenuGroup.#SettingsMenu.2',
  },

  /** help page text */
  helpPageText: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#settingsScreen.#PanelSet.3.#Offset.#ContentGroup.#TextTwo',
  },

  /** Device ID label */
  deviceIdText: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#settingsScreen.#PanelSet.3.#Offset.#ContentGroup.#TextTwoGroup.3',
  },

  /** Help link */
  helpLinkText: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#settingsScreen.#PageGroup.#PanelSet.3.#Offset.#ContentGroup.#TextTwoGroup.0',
  },

  /** Policy Page Header */
  privacyPolicyHeader: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#settingsScreen.#PanelSet.3.#Offset.#panelContentSection.#heading',
  },
  ...
  categoriesListMenu: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#categoryPanelListScreen.#PageGroup.#PanelSet.2.#MenuGroup.#Menu'
  },

  channelRecommendedButton: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#categoryPanelListScreen.#PageGroup.#PanelSet.2.#MenuGroup.#Menu.0.#DetailsMenuTextParent.#DetailsMenuTextFocused',
  },
  ...
  networksInfoPanel: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#categoryDetailsScreen.#PageGroup.#ChannelsInfoPanel.#infoPanelGroup.#Offset',
  },

  /** Category  Action */
  channelCategoryPosterTitle2: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#categoryListScreen.#PageGroup.#ChannelCategoryGrid.2.#Title',
  },

  /** Category Adult Animation */
  channelCategoryPosterTitle4: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#categoryListScreen.#PageGroup.#ChannelCategoryGrid.4.#Title',
  },
  ...
  categoryHeader: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#categoryPanelListScreen.#PageGroup.#PanelSet.3.#PageGroup.#PageAnimatedGroup.#pageTitleAndCounter.#CategoryName',
  },
  ...
  categoryRatingsLabel: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#categoryPanelListScreen.#PageGroup.#PanelSet.3.#PageGroup.#PageAnimatedGroup.#ChannelsInfoPanel.#infoPanelGroup.#Offset.#TwoLineInfo.#FirstLineGroup.#Rating.#RatingBackground',
  },
  ...
  categoryPosterFirst: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#categoryPanelListScreen.#PageGroup.#PanelSet.3.#PageGroup.#PageAnimatedGroup.#ChannelsContentGrid.0.#poster',
  },

  actionButtonFocused: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#categoryPanelListScreen.#PageGroup.#PanelSet.2.#MenuGroup.#Menu.2',
  },
  ...
  titleNameInCategories: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#categoryPanelListScreen.#PageGroup.#PanelSet.3.#PageGroup.#PageAnimatedGroup.#ChannelsInfoPanel.#infoPanelGroup.#Offset.#Title'
  },
  ...
  recommendedCategoryPage: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#categoryListScreen.#ChannelCategoryGrid.0.#Title',
  },

  /** Call to Action text on Recommended screen */
  recommendedScreenCallToAction: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#categoryDetailsScreen.#nav.#ScreenNavigationHint.#callToAction',
  },
  ...
  titleNameInPlayer: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#videoPlayerScreen.#TopOverlay.#VideoOverlayTitle',
  },

  titleDescriptionInChannelGrid: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#categoryDetailsScreen.#ChannelsInfoPanel.#infoPanelGroup.#Offset.#DescriptionGroup.#Description',
  },
  ...
  titleDescriptionHomesScreen: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#homeScreen.#PageGroup.#InfoPanelParent.#InfoPanel.#infoPanelGroup.#Offset.#DescriptionGroup.#Description',
  },
  ...
  liveNewsSubtitlesPanel: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#linearVideoPlayerScreen.#VideoOverlay.#overlayParent.#closedCaptioningGroup.#closedCaptioningButtonList',
  },
  ...
  horsesAndPoniesTile: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#categoryListScreen.#ChannelCategoryGrid.9.#Title',
  },
  ...
  artHouseFilms: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#categoryPanelListScreen.#PageGroup.#PanelSet.2.#MenuGroup.#Menu.7.#DetailsMenuTextParent.#DetailsMenuText',
  },
  ...
  parentalControlsMenuTextFocused: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#settingsScreen.#PanelSet.2.#SettingsMenuGroup.#SettingsMenu.0.#DetailsMenuTextParent.#DetailsMenuTextFocused',
  },
  ...
  searchGrid: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#searchScreen.#searchGroup.#SearchKeyboard.0',
  },

  /** No results message */
  noResultsMessage: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#searchScreen.#ResultArea.#NoResultsMessage',
  },
  ...
  sendFeedBackButton: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#videoPlayerScreen.#HUD.#Transport.#TransportButtons.#sendFeedBackButton',
  },

  /** Send Feedback overlay group (for visibility) */
  sendFeedbackSelectionOverlayGroup: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#videoPlayerScreen.#sendFeedbackSelectionOverlayGroup',
  },

  /** Send Feedback overlay container (child list/focus) */
  sendFeedbackSelectionOverlay: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#videoPlayerScreen.#sendFeedbackSelectionOverlay',
  },

  SendFeedbackQRCodeOverlayOnPlayer: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#videoPlayerScreen.#sendFeedbackSelectionOverlay.0',
  },

  sendFeedbackQRCodeHeaderLabel: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#videoPlayerScreen.#sendFeedbackSelectionOverlayGroup.#sendFeedbackSelectionOverlay.2',
  },

  closeButton: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#videoPlayerScreen.#sendFeedbackSelectionOverlayGroup.#sendFeedbackSelectionOverlay.2.#overlayBackground.#sendFeedbackSection.#sendFeedbackHeaderLabel',
  },

  closedCaptionAndAudioSelectionOverlay: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#videoPlayerScreen.#closedCaptionAndAudioSelectionOverlayGroup',
  },
  ...
  audioTracksSectionHeader: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#videoPlayerScreen.#closedCaptionAndAudioSelectionOverlayGroup.#closedCaptionAndAudioSelectionOverlay.#overlayBackground.0.#audioTracksSection.#audioTracksSectionHeaderLabel',
  },

  /** Audio Description text check */
  audioDescriptionText: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#videoPlayerScreen.#closedCaptionAndAudioSelectionOverlayGroup.#closedCaptionAndAudioSelectionOverlay.#overlayBackground.0.#audioTracksSection.#audioTrackSelector.1.#BtnLayout.#Text',
  },

  /** sign out button selected */
  signOutButtonSelected: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#settingsScreen.#PanelSet.2.#SettingsMenuGroup.#SettingsMenu.6.#DetailsMenuTextParent.#DetailsMenuText',
  },

  /** audio desc enabled */
  audioDescriptionEnabled: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#videoPlayerScreen.#closedCaptionAndAudioSelectionOverlayGroup.#closedCaptionAndAudioSelectionOverlay.0.1.2.#OverLayItemsLayoutGroup.2.1.#container',
  },

  /** audio description item content */
  audioDescriptionItemContent: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#videoPlayerScreen.#closedCaptionAndAudioSelectionOverlayGroup.#closedCaptionAndAudioSelectionOverlay.#overlayBackground.0.#audioTracksSection.#audioTrackSelector.1.itemContent',
  },

  /** Audio Descriptio item checked */
  audioDescriptionItemChecked: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#videoPlayerScreen.#closedCaptionAndAudioSelectionOverlayGroup.#closedCaptionAndAudioSelectionOverlay.0.1.2.#OverLayItemsLayoutGroup.2.1.#container.0.#checkIcon',
  },

  /** subtitle OFF */
  subtitleOff: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#videoPlayerScreen.#closedCaptionAndAudioSelectionOverlayGroup.#closedCaptionAndAudioSelectionOverlay.#overlayBackground.0.#closedCaptionSection.#closedCaptionSelector.0',
  },

  /** subtitle enabled */
  subTitleEnabled: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#videoPlayerScreen.#closedCaptionAndAudioSelectionOverlayGroup.#closedCaptionAndAudioSelectionOverlay.0.1.1.#OverLayItemsLayoutGroup.2.1',
  },
  ...
  autoPlayContentPoster: {
    keyPath: '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#videoPlayerScreen.#UpNext.#UpNextUI.#UpNextParent.#UpNextSeriesGroup.#GridSeries.0'
  },

  countDownAutoPlay: {
    keyPath: '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#videoPlayerScreen.#UpNext.#UpNextUI.#CountdownGroup.#CountdownText',
  },
  ...
  countDownSecondsAutoPlay: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#videoPlayerScreen.#UpNext.#UpNextUI.#CountdownGroup.#CountdownSeconds',
  },
  ...
  autoplayUISeriesGrid: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#videoPlayerScreen.#UpNext.#UpNextUI.#UpNextParent.#UpNextSeriesGroup.#GridSeries',
  },

  /** remaining time in player timer */
  remainingLabel: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#videoPlayerScreen.#HUD.#Transport.#RemainingLabel',
  },

  /** current time in player timer */
  currentTimePlayed: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#videoPlayerScreen.#HUD.#Transport.#ElapsedLabel',
  },

  /** autoplay option year and duration info */
  autoPlayYearAndDuration: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#videoPlayerScreen.#UpNext.#UpNextUI.#UpNextMovieGroup.#InfoMovie.#infoPanelGroup.#Offset.#TwoLineInfo.#FirstLineGroup.#Line1',
  },
  ...
  featuredRow: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#homeScreen.#ContentArea.#CategoryGridList.#RowList.1.title.#CategoryName',
  },

  /** Featured text is shown */
  featuredHeader: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#homeScreen.#PageGroup.#ContentArea.#CategoryGridList.#RowList.0.title.#CategoryName',
  },

  /** Featured row poster */
  featuredRowPoster: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#homeScreen.#ContentArea.#CategoryGridList.#RowList.0.items.0.#poster',
  },
  ...
  infoPanelTitle: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#homeScreen.#PageGroup.#InfoPanelParent.#InfoPanel.#infoPanelGroup.#Offset.#Title',
  },
  /** info panel title movies screen */
  infoPanelTitleMovies: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#movieScreen.#PageGroup.#InfoPanelParent.#InfoPanel.#infoPanelGroup.#Offset.#Title',
  },

  /** age gate number page */
  ageVerificationPad: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.2.#AgeVerificationNumberPadGroup.#AgeVerificationNumberPad.#keyboard.0',
  },

  /** Start Watching button on age verification screen */
  ageVerificationStartButton: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.2.#AgeVerificationNumberPadGroup.#AgeVerificationStartButton',
  },

  /** Autoplay Title */
  autoPlayTitle: {
    keyPath: '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#videoPlayerScreen.#UpNext.#UpNextUI.#UpNextParent.#UpNextMovieGroup.#movieTiles.#FocusBox',
  },

  /** top nav For You */
  selectedTopNavForYouItem: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#homeScreen.#PageGroup.#topNav-home.#TopNavMenu.0',
  },

  /** top nav Movies */
  topNavMoviesItem: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#homeScreen.#PageGroup.#topNav-home.#TopNavMenu.1.#unfocusedTopLabel',
  },

  /** top nav TV Shows */
  topNavTVShowsItem: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#homeScreen.#PageGroup.#topNav-home.#TopNavMenu.2.#unfocusedTopLabel',
  },

  /** top nav Live TV */
  topNavLiveItem: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#homeScreen.#PageGroup.#topNav-home.#TopNavMenu.3.#unfocusedTopLabel',
  },
  ...
  programGuideHeaderText: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#epgScreen.#topNav-linearEPG-linearEPG-linearEPG.#TopNavMenu.3.#Underline',
  },

  programGuide: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#epgScreen.#PageGroup.#programGuide.0',
  },

  epgProgramGrid: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#epgScreen.#PageGroup.#programGuide.#channelsGrid.0.#ChannelPoster',
  },

  linearEPGProgramGrid: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#epgScreen.#PageGroup.#programGuide.#ProgramGrid',
  },
  ...
  searchMenuText: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#searchScreen.#leftSide.#searchMenuText',
  },
  ...
  networksCategoryButton: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#categoryPanelListScreen.#PageGroup.#PanelSet.2.#MenuGroup.#Menu.1.#DetailsMenuTextParent.#DetailsMenuTextFocused',
  },
  ...
  exitItem: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#settingsScreen.#PageGroup.#PanelSet.2.#SettingsMenuGroup.#SettingsMenu.5.#DetailsMenuTextParent.#DetailsMenuText',
  },

  /** Exit item selected */
  exitItemSelected: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#settingsScreen.#PageGroup.#PanelSet.2.#SettingsMenuGroup.#SettingsMenu.5.#IconParent.#IconFocused',
  },

  /** parental controls button */
  parentalControlsButton: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#settingsScreen.#PanelSet.2.#SettingsMenuGroup.#SettingsMenu.0',
  },
  ...
  searchHintText: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#searchScreen.#searchHintText',
  },
  ...
  continueWatchingPoster: {
    keyPath: ' #ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#categoryPanelListScreen.#PageGroup.#PanelSet.3.#PageGroup.#PageAnimatedGroup.#ChannelsContentGrid.0.#posterLayout.#Poster',
  },
  ...
  categoryPagePoster: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#categoryListScreen.#PageGroup.#ChannelCategoryGrid.0.#PosterRect',
  },
  ...
  guestMenu: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#myStuffScreen.#PageGroup.#SignedOutUI.#GuestMenu',
  },

  unlockNowForMyStuff: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#myStuffScreen.#PageGroup.#SignedOutUI.#GuestMenu.0.#DetailsMenuTextParent.#DetailsMenuTextFocused',
  },

  myStuffGuestScreenTextTitle: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#myStuffScreen.#PageGroup.#SignedOutUI.#SignedOutUITitle',
  },

  myStuffGuestScreenTextSubTitle: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#myStuffScreen.#PageGroup.#SignedOutUI.#SignedOutUISubtitle',
  },
  ...
  myStuffAllEmptyUIMenu: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#myStuffScreen.#PageGroup.#AllEmptyUI.#AllEmptyUIMenu',
  },
  ...
  categoriesVideoGrid: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#channelListScreen.#PageGroup.#ChannelCategoryGrid',
  },

  categoryDetailsVideoGrid: {
    keyPath: '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#categoryDetailsScreen.#PageGroup.#ChannelsVideoGrid',
  },
  ...
  ageVerificationNumberPad: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.1.#AgeVerificationNumberPadGroup.#AgeVerificationNumberPad.#keyboard.0',
  },

  /** age verification years page */
  yearsVerificationEntry: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.3.#AgeVerificationPageText.#AgeVerificationPageHeader',
  },

  /** CW tile on Categories page */
  categoriesContinueWatchingTile: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#categoryListScreen.#ChannelCategoryGrid.1.#Title',
  },
  ...
  kidsSearchKeyPad: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#searchScreen.#PageGroup.#searchGroup.#SearchKeyboard.0',
  },
  ...
  espanolScreenRowList: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#espanolScreen.#ContentArea.#CategoryGridList.#RowList',
  },
  ...
  settingsScreenTitle: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#settingsScreen.#Title',
  },
  ...
  seriesSignUpToSaveProgressButtonText: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#detailScreen.#AnimationGroup.#Menu.1.#DetailsMenuTextParent.#DetailsMenuText',
  },
  ...
  seriesSignUpToSaveProgressButtonTextOnDetailsPageWithHistory: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#detailScreen.#AnimationGroup.#Menu.2.#DetailsMenuTextParent.#DetailsMenuText',
  },
  ...
  moviesSignUpBadgeLabelText: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#detailScreen.#AnimationGroup.#Menu.1.#badgeLabel.#textLabel',
  },
  ...
  emailTextEditBox: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#emailInputScreen.#emailLayout.1.#emailTextEditBox.1',
  },

  /** Sign In Screen page header */
  signInScreenPageHeader: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#signInScreen.#signUpLayout.#pageHeading',
  },

  /** EPG countdown text */
  epgCountDownText: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#epgScreen.#infoPanelParent.#infoPanel.#PlayerCountdownGroup.#CountdownText',
  },

  /** homescreen news countdown */
  homeScreenNewsCountdown: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#homeScreen.#InfoPanelParent.#InfoPanel.#infoPanelGroup.#Offset.#PlayerCountdownGroup.#CountdownText',
  },
  ...
  searchResultGrid: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#searchScreen.#PageGroup.#rightSide.#ResultArea.#gridContainer.#resultsContainer.#ResultGrid',
  },
  ...
  reactionButtonLiked: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#detailScreen.#PageGroup.#AnimationGroup.#Menu.1.#DetailsMenuTextParent.#DetailsMenuTextFocused',
  },

  /** Secondary Menu Like highlighted */
  likeButtonFocused: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#detailScreen.#PageGroup.#AnimationGroup.#SecondaryMenu.0.#DetailsMenuTextParent.#DetailsMenuTextFocused',
  },

  /** Secondary Menu Disliked highlighted */
  DislikedButtonFocused: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#detailScreen.#PageGroup.#AnimationGroup.#SecondaryMenu.1.#DetailsMenuTextParent.#DetailsMenuTextFocused',
  },
  ...
  categoryDetailsScreenTitleCount: {
    keyPath: '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#categoryDetailsScreen.#PageGroup.#pageTitleAndCounter.#CategoryCount',
  },

  /* the indicator of tile's index on content list page */
  categoryDetailsScreenFocusIndex: {
    keyPath: '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#categoryDetailsScreen.#PageGroup.#pageTitleAndCounter.#CategoryCount.#FocusIndex',
  },
  ...
  // Accept Now button
  acceptNowButton: {
    keyPath: '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#homeScreen.#PageGroup.#ContentArea.#CategoryGridList.#purpleCarpetRow.0.#infoPanelGroup.#ctaButtonList.0.#menuItemTextFocused',
  },
  ...
  helpIsOnTheWayScreenTitle: {
    keyPath: '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#forgotPasswordProcessingScreen.#pageLayout.#pageHeading'
  },
  ...
  continueWatchingConsentPageAcceptButton: {
    keyPath: '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#rokuContinueWatchingConsentScreen.0.#buttonList.0'
  },
  ...
  loadingProgressBar: {
    keyPath: '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#videoPlayerScreen.#Loading.#LoadingProgressBar'
  },

  /** "View Privacy Settings" button in Privacy Center panel */
  managePrivacySettingsButton: {
    keyPath: '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#settingsScreen.#PageGroup.#PanelSet.#privacyCenterPanel.#Offset.#panelContentSection.#managePrivacySettingsButton'
  },

  // Privacy Center Continue Watching Header
  privacyCenterContinueWatchingHeader: {
    keyPath: '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#settingsScreen.#PageGroup.#PanelSet.#privacyCenterPanel.#Offset.#panelContentSection.#managePreferences.#preferenceMenu.0.#contentSection.1.#title'
  },

  // Privacy Center Continue Watching Toggle
  privacyCenterContinueWatchingToggle: {
    keyPath: '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#settingsScreen.#PageGroup.#PanelSet.#privacyCenterPanel.#Offset.#panelContentSection.#managePreferences.#preferenceMenu.0.#contentSection.2.1.#toggleText'
  },

  /** Preview on button */
  autoplayPreviewOn: {
    keyPath: '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#settingsScreen.#PanelSet.3.#Offset.#ContentGroup.#AutoplayPreviewMenu.0'
  },

  autoplayPreviewMenu: {
    keyPath: '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#settingsScreen.#PanelSet.#AutoplayPreviewMenu'
  },

  // Preview Off Checked
  previewOffCheckMark: {
    keyPath: '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#settingsScreen.#PageGroup.#PanelSet.3.#Offset.#ContentGroup.#AutoplayPreviewMenu.1.#container.0.#checkIcon',
  },
  // Preview On Checked
  previewOnCheckMark: {
    keyPath: '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#settingsScreen.#PageGroup.#PanelSet.3.#Offset.#ContentGroup.#AutoplayPreviewMenu.0.#container.0.#checkIcon',
  },

  autoplayNextVideoMenu: {
    keyPath: '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#settingsScreen.#PanelSet.#AutoPlayTimerMenu'
  },
  ...
  vodDetailScreen: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#vodDetailScreen',
  },

  /** Action button list on VOD Detail Screen (Resume, Play from Beginning, Add to Queue, Like, Dislike, Go to Channel) */
  vodDetailScreenMenu: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#vodDetailScreen.#actionButtonList',
  },

  /** Section tabs on VOD Detail Screen (Episodes, More Like This, Trailers) */
  vodDetailScreenSectionTabs: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#vodDetailScreen.#sectionTabs',
  },

  /** Season list (buttons) on VOD Detail Screen (for series) */
  vodDetailScreenSeasonList: {
    keyPath:
      '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#vodDetailScreen.#episodesContainer.#seasonButtonsList',
  },
  ...
  vodDetailScreenTitleImage: {
    keyPath: '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#vodDetailScreen.#contentGroup.#contentContainer.#videoMetadataPanel.#metadataGroup.#infoPanel.#metadataGroup.#titleImage.#titleArt',
  },

  /** detailScreenTitle - Title text label shown in details page */
  vodDetailScreenTitle: {
    keyPath: '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#vodDetailScreen.#contentGroup.#contentContainer.#videoMetadataPanel.#metadataGroup.#infoPanel.#metadataGroup.#title',
  },

  /** contentTitleImage - Title image shown when scrolled down */
  contentTitleImage: {
    keyPath: '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#vodDetailScreen.#contentTitle.#contentTitleImage',
  },

  /** contentTitleLabel - Typed text title shown when scrolled down (when no titleImageUrl) */
  contentTitleLabel: {
    keyPath: '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#vodDetailScreen.#contentTitle.#contentTitleLabel',
  },

  /** vodDetailScreenDescription - Description text in video metadata panel */
  vodDetailScreenDescription: {
    keyPath: '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#vodDetailScreen.#contentGroup.#contentContainer.#videoMetadataPanel.#metadataGroup.#infoPanel.#metadataGroup.#description',
  },

  /** vodDetailScreenActionButtons */
  vodDetailScreenActionButtons: {
    keyPath: '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#vodDetailScreen.#actionButtonList',
  },

  /** playButtonLabel */
  playButtonLabel: {
    keyPath: '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#vodDetailScreen.#contentContainer.#actionButtonList.#play',
  },

  /** Add to My List button label (unfocused state) */
  addToMyListButtonLabelUnfocused: {
    keyPath: '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#vodDetailScreen.#actionButtonList.#addToQueue.#elementsGroup.#titleGroup.#labelGroup.#label',
  ...
  addToMyListButtonLabelFocused: {
    keyPath: '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#vodDetailScreen.#actionButtonList.#addToQueue.#elementsGroup.#titleGroup.#labelGroup.#labelFocused',
  ...
  likeButtonLabelGroup: {
    keyPath: '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#vodDetailScreen.#actionButtonList.#like.#elementsGroup.#titleGroup.#labelGroup',
  },

  dislikeButtonLabelGroup: {
    keyPath: '#ContentController.#uiGroup.#ContentGroup.#screenStackGroup.#ScreenStack.#vodDetailScreen.#actionButtonList.#dislike.#elementsGroup.#titleGroup.#labelGroup',
  },
